...
To accelerate our 150,000-ton ship, the sail needs to receive ~120 terawatts of power.

With a huge 1 km² sail:
- Power density: 120 TW ÷ 1,000,000 m² = **120 MW/m²**

### For Comparison

- Sunlight at Earth: 1.4 kW/m²
- Laser sail receives: **85,000× solar intensity**
...
Any material absorbing 120 MW/m² will vaporize almost instantly.

### Even with Reflective Sails

| Reflectivity | Power Absorbed | Result |
|--------------|---------------|--------|
| 99.0% | 1.2 MW/m² | Vaporizes quickly |
| 99.9% | 120 kW/m² | Still vaporizes |
| 99.99% | 12 kW/m² | Failure in minutes |

**Perfect mirrors don't exist.** Quantum mechanics ensures some absorption occurs.
...
| **Our requirement** | **120 TW** | **Years** | 1.2 million × strongest continuous laser |

**The scaling problem:**
- Current best continuous lasers: ~100 kW
- We need: 120 TW = 120,000,000,000 kW
- Gap: **1.2 billion-fold increase**

NIF achieves 500 TW but only for 20 nanoseconds - then requires hours to recharge. We need that power **continuously for 20 years**.

### Can We "Just Build More Lasers"?

**Efficiency limits:**
- Best laser efficiency: ~50% (electrical → light)
- To output 120 TW of laser light: need ~240 TW of electrical input
- Plus cooling systems for the 120 TW of waste heat
...
How does 120 MW/m² on the sail compare to the most violent events in the universe?
...
| **~540 AU** | **~1.2×10⁸ W/m²** | **≈ Our laser sail** |
| 1 light-year | ~10⁴ W/m² | Survivable with shielding |

**Our laser sail: 120 MW/m² = 1.2×10⁸ W/m²**

This is equivalent to being **~540 AU from a supernova** - about 18× Pluto's orbit during the explosion.

**What happens at 120 MW/m²?**
- This is **85,000× solar intensity** at Earth
- Water boils at ~50 liters/second per m²
- Rock melts within seconds
- Any atmosphere would be blasted away
- No surface life survives - the planet becomes a molten ball
...
- Equivalent distance for sail intensity: **~0.86 light-years from a quasar core**
- Nothing survives within a light-year of an active quasar

**Sun's surface:**
- Solar surface radiates: ~63 MW/m²
- Our laser sail receives: **twice the sun's surface intensity**
- The sail is literally hotter than the surface of the sun

### Summary: Where We Stand

| Energy Source | Power Density | Distance for 120 MW/m² |
|---------------|---------------|------------------------|
| Sunlight at Earth | 1.4 kW/m² | N/A - 85,000× too weak |
| Sun's surface | 63 MW/m² | Standing on it (2× intensity) |
| Supernova peak | 10³⁷ W total | ~540 AU |
| Fast Radio Burst | 10³² W total | ~1.7 AU |
| Quasar | 10⁴⁰ W total | ~0.86 light-years |
| **Laser sail** | **120 MW/m²** | **Experienced continuously for years** |

The sail experiences power densities that in nature only occur near the most violent events in the universe - and must survive it not for milliseconds (like an FRB) but for **years**.
...
To provide 120 TW of laser power at the sail:
- This is **~60× humanity's total current power generation**
- Must be sustained for years (acceleration phase)
- Total energy: ~10²³ joules over the acceleration period
...
For a 1000 km × 1 km sail (1000 km²):
- Even at 1 g/m² (thinner than paper): **1 million tons** of sail material
- This exceeds our ship mass!

For more realistic 10 g/m² material:
- Sail mass: **10 million tons**
- The "ship" is now almost entirely sail

### The Poles and Rigging

A sail needs structure to maintain shape:

**For a 1 km × 1 km sail:**
- Structural poles/cables to hold shape
- At these scales, even gossamer structures have enormous mass
- Cable from edge to center (500m): minimum cross-section for tension
- Aluminum poles: ~10-100 tons minimum
- Carbon fiber rigging: additional tons

**For a 1000 km sail:**
- Structural mass scales with area (roughly)
- We're talking **millions of tons** of rigging
- The structure mass dominates everything
- No material has sufficient strength-to-weight ratio

### The Shape Maintenance Problem

A 1000 km sail under laser pressure:
...
- Active control across 1000 km? With what actuators?
...
### Ridiculously Large Sail

- 1,000 km² sail (~32 km × 32 km square)
- Power density drops to 120 W/m² (manageable)
- But sail mass becomes millions of tons
- Ship payload must reduce to ~100 tons to maintain any acceleration
- **Can't carry anything useful**

### Very Slow Acceleration

- Accelerate at 0.001g over centuries
- Power requirements drop by 1000×+
- **Journey takes 10,000+ years**
- Not really "travel" anymore
...
|---------|----------|-------|
| Thermal destruction of sail | **Fatal** | No material survives 120 MW/m² |
| Laser array size | Extreme | Death Star-scale optics needed |
| Power requirements | Extreme | 600,000× human civilization output |
| Beam divergence | **Fatal** | Beam spreads to uselessness at distance |
| Aiming precision | **Fatal** | Light-speed delay prevents correction |
| Sail structural mass | Extreme | Sail outweighs ship by orders of magnitude |
...
1. **Thermal destruction** - Same heat problem as all propulsion
2. **Laser array impossible** - Requires Death Star-scale infrastructure
3. **Beam divergence** - Power becomes useless at interstellar distances  
4. **Aiming impossible** - Light-speed delay prevents correction
5. **Sail mass** - Structure outweighs payload
6. **No braking** - Cannot stop at destination
